...
<!-- 
 ...
 and a second screen for showing base details of that character using the endpoint (https://swapi.dev/api/people/:id/) and a section on the same screen showing the movie names that character has appeared in. -->